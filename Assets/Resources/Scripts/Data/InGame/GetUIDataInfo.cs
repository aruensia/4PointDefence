...
public class GetUIDataInfo : MonoBehaviour
{
    ...
    void SetupGameOverInfo()
    {
        ...
        gameOverGetMoney.text = "획득 재화 : " + Manager.Instance.inGameManager.getMoney.ToString();
    }
    ...
    {
        currentGetMoney.text = "얻은 돈 : "+Manager.Instance.inGameManager.getMoney.ToString();
    }
